...
export const baseEmailOrUsernamePlugin: AuthPlugin<
...
const emailOrUsernamePlugin = (
...
): AuthPlugin<EmailOrUsernameConfig, 'email-or-username'> =>
  createAuthPlugin<EmailOrUsernameConfig, 'email-or-username'>(
  ...
  ) as AuthPlugin<EmailOrUsernameConfig, 'email-or-username'>;

...
// OAuth Providers
export { googleOAuthPlugin, type GoogleOAuthConfig } from './google-oauth.plugin';
export { facebookOAuthPlugin, type FacebookOAuthConfig } from './facebook-oauth.plugin';
export { githubOAuthPlugin, type GitHubOAuthConfig } from './github-oauth.plugin';
export { linkedinOAuthPlugin, type LinkedInOAuthConfig } from './linkedin-oauth.plugin';
export { discordOAuthPlugin, type DiscordOAuthConfig } from './discord-oauth.plugin';
export { auth0OAuthPlugin, type Auth0OAuthConfig } from './auth0-oauth.plugin';
export { spotifyOAuthPlugin, type SpotifyOAuthConfig } from './spotify-oauth.plugin';
export { microsoftOAuthPlugin, type MicrosoftOAuthConfig } from './microsoft-oauth.plugin';
export { twitterOAuthPlugin, type TwitterOAuthConfig } from './twitter-oauth.plugin';
export { twitchOAuthPlugin, type TwitchOAuthConfig } from './twitch-oauth.plugin';
export { appleOAuthPlugin, type AppleOAuthConfig } from './apple-oauth.plugin';
export { workosOAuthPlugin, type WorkOSOAuthConfig } from './workos-oauth.plugin';
export { redditOAuthPlugin, type RedditOAuthConfig } from './reddit-oauth.plugin';

// Import for re-export object
import { createOAuthPlugin, defaultUserInfoFetchers } from './utils/oauth-plugin-factory';

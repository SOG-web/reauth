...
export type { OAuthDiscoveryConfigV2, OAuthDiscoveryMetadata, OAuthProtectedResourceMetadata } from './types';
 ...
 */
const oAuthDiscoveryPluginV2: AuthPluginV2<OAuthDiscoveryConfigV2> = createOAuthDiscoveryPluginV2({});

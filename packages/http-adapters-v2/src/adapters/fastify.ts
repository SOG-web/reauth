...
export class FastifyAdapterV2 implements FrameworkAdapterV2<FastifyRequest, FastifyReply, never> {
   ...
   */
  handleError(reply: FastifyReply, error: Error, statusCode: number = 500): void {
 ...
 */
export function createFastifyAdapter(config: HttpAdapterV2Config): FastifyAdapterV2 {
